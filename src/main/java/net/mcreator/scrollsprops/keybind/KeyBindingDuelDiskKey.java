...
package net.mcreator.scrollsprops.keybind;
...
import net.mcreator.scrollsprops.procedure.ProcedureDueldiskcloseOnKeyPressed;
...
public class KeyBindingDuelDiskKey extends ElementsScrollspropsMod.ModElement {
	private KeyBinding keys;
	public KeyBindingDuelDiskKey(ElementsScrollspropsMod instance) {
		super(instance, 286);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.duel_disk_key", Keyboard.KEY_5, "key.categories.misc");
	...
	public void onKeyInput(InputEvent.KeyInputEvent event) {
		if (Minecraft.getMinecraft().currentScreen == null) {
			if (org.lwjgl.input.Keyboard.isKeyDown(keys.getKeyCode())) {
				ScrollspropsMod.PACKET_HANDLER.sendToServer(new KeyBindingPressedMessage());
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureDueldiskcloseOnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
