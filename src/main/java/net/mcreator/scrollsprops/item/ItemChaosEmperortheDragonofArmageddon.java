...
public class ItemChaosEmperortheDragonofArmageddon extends ElementsScrollspropsMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("scrollsprops:chaos_emperorthe_dragonof_armageddon", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("chaos_emperorthe_dragonof_armageddon");
			setRegistryName("chaos_emperorthe_dragonof_armageddon");
