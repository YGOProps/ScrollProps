...
public class ItemTranscendosaurusGlaciasaurus extends ElementsScrollspropsMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("scrollsprops:transcendosaurus_glaciasaurus", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("transcendosaurus_glaciasaurus");
			setRegistryName("transcendosaurus_glaciasaurus");
