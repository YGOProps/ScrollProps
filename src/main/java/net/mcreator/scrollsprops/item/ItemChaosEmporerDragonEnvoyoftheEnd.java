...
public class ItemChaosEmporerDragonEnvoyoftheEnd extends ElementsScrollspropsMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("scrollsprops:chaos_emporer_dragon_envoyofthe_end", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("chaos_emporer_dragon_envoyofthe_end");
			setRegistryName("chaos_emporer_dragon_envoyofthe_end");
