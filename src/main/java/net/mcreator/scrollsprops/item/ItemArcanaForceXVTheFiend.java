...
public class ItemArcanaForceXVTheFiend extends ElementsScrollspropsMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("scrollsprops:arcana_force_xv_the_fiend", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("arcana_force_xv_the_fiend");
			setRegistryName("arcana_force_xv_the_fiend");
