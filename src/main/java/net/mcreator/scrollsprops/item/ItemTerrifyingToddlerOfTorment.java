...
public class ItemTerrifyingToddlerOfTorment extends ElementsScrollspropsMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("scrollsprops:terrifying_toddler_of_torment", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("terrifying_toddler_of_torment");
			setRegistryName("terrifying_toddler_of_torment");
