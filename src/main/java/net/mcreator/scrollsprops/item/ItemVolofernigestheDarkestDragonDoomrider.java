...
public class ItemVolofernigestheDarkestDragonDoomrider extends ElementsScrollspropsMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("scrollsprops:volofernigesthe_darkest_dragon_doomrider", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("volofernigesthe_darkest_dragon_doomrider");
			setRegistryName("volofernigesthe_darkest_dragon_doomrider");
