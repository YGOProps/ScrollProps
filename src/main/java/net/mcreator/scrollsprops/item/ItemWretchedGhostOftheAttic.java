...
public class ItemWretchedGhostOftheAttic extends ElementsScrollspropsMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("scrollsprops:wretched_ghost_ofthe_attic", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("wretched_ghost_ofthe_attic");
			setRegistryName("wretched_ghost_ofthe_attic");
