...
public class ItemMythicalBeastMasterCerberus extends ElementsScrollspropsMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("scrollsprops:mythical_beast_master_cerberus", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("mythical_beast_master_cerberus");
			setRegistryName("mythical_beast_master_cerberus");
