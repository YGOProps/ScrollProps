...
public class ItemElementalHeroFlameWingman extends ElementsScrollspropsMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("scrollsprops:elemental_hero_flame_wingman", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("elemental_hero_flame_wingman");
			setRegistryName("elemental_hero_flame_wingman");
