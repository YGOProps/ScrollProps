...
public class ItemArcanaForceXIVTemprance extends ElementsScrollspropsMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("scrollsprops:arcana_force_xiv_temprance", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("arcana_force_xiv_temprance");
			setRegistryName("arcana_force_xiv_temprance");
