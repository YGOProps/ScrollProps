...
public class ItemBurialFromADifferentDimension extends ElementsScrollspropsMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("scrollsprops:burial_from_a_different_dimension", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("burial_from_a_different_dimension");
			setRegistryName("burial_from_a_different_dimension");
